...
type AddStyleProp = (property: string, value: unknown, moveTokens?: string[]) => void;
...
export declare function parseLength(length: number | Length | DimensionPercentageFor_LengthValue | NumberOrPercentage | LengthValue, options: ParseDeclarationOptionsWithValueWarning): number | string | RuntimeValueDescriptor | undefined;
export {};
